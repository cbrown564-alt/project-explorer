...
export const THEME_COLORS: Record<string, { bg: string; text: string; border: string }> = {
  ...
  "NLP": { bg: "bg-green-50 dark:bg-green-950", text: "text-green-800 dark:text-green-300", border: "border-green-200 dark:border-green-800" },
  "Knowledge Engineering": { bg: "bg-orange-50 dark:bg-orange-950", text: "text-orange-800 dark:text-orange-300", border: "border-orange-200 dark:border-orange-800" },
  "AI for Health": { bg: "bg-rose-50 dark:bg-rose-950", text: "text-rose-800 dark:text-rose-300", border: "border-rose-200 dark:border-rose-800" },
  "Other": { bg: "bg-slate-50 dark:bg-slate-950", text: "text-slate-800 dark:text-slate-300", border: "border-slate-200 dark:border-slate-800" },
};
